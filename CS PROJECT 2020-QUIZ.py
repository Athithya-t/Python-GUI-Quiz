...
che_hard_q=["Who is placed 5th in the fide ranking(India)?"
        ...
        ,"Despite being the lowest rated player at the 2017 Tata Steel Masters Tournament, he managed to finish third with a score of 7.5 points out of 13 (+4-2=7). He defeated Sergey Karjakin, Dmitry Andreikin, Richárd Rapport, and Radosław Wojtaszek.Who is he??"
...
che_hard_h=["One part of his name is the name of a important character in mahabharatham"
            ...
            ,"He is married to former Women's World Chess Champion Susan Polgár."
...
bas_hard_q=["Who invented basketball?",
    ...
    "In 1999, which Boston Celtics player ranked number 30 in ESPN’s Sports Century’s 50 Greatest Athletes of the 20th century?",
    "What were used as the first “baskets”?",
    ...
    "Apart from USA, which other current country has won a mens’ Olympic gold medal?",
